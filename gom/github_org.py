...
class GithubOrganizationManager:
    ...
    def read_members_from_txt(self, txtfile):
        ...
        with open(txtfile) as userfile:
            ...
            users = list(map(self._github.get_user, user_names))
            return users
    ...
    def delete_repo(self, repo_name):
        ...
        try:
            ...
            print("    Repo ‘%s’ already gone. Ignoring..." % repo_name)
    ...
    def delete_repos_in_file(self, txtfile):
        ...
        if choice != 'yes':
            ...
            print('  Remark: Type ‘yes’ to confirm, not ‘y’')
            return
    ...
    def delete_team(self, team_name):
        ...
        try:
            ...
            print("    team ‘%s’ already gone. Ignoring..." % team_name)
